    ...
    return (
        <div className="sidebar border border-1 border-black">
            <div className="list-group" style={{ backgroundColor: "grey" }}>
                <Link to="./" className="list-group-item list-group-item-action" style={{ backgroundColor: "grey" }}>Dashboard</Link>
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                        <div className="list-group">
                            ...
                            <Link to="./specification" className="list-group-item list-group-item-action">Specifications</Link>
                        </div>
                    </div>
                </div>
            </div>
